import AbstractTypescriptSdkGraphQLSourceCodeGenerator from "./AbstractTypescriptSdkGraphQLSourceCodeGenerator";
import {code_generator_options} from "./types";

export class GenericTypescriptSdkGraphQLSourceCodeGenerator extends AbstractTypescriptSdkGraphQLSourceCodeGenerator {
...
export default GenericTypescriptSdkGraphQLSourceCodeGenerator;